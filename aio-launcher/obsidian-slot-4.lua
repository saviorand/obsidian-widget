...
-- Bound to ObsidianWidgetProvider4, NOT the same component as
...
-- com.obsidianwidget/.ObsidianWidgetProvider4, not the plain one.

local prefs = require "prefs"

local PROVIDER = "com.obsidianwidget/com.obsidianwidget.ObsidianWidgetProvider4"
...
local function refresh()
    ...
    intent:send_broadcast{
        ...
        component = "com.obsidianwidget/com.obsidianwidget.ObsidianWidgetProvider4",
    }
