...
-- Bound to ObsidianWidgetProvider3, NOT the same component as
...
-- com.obsidianwidget/.ObsidianWidgetProvider3, not the plain one.

local prefs = require "prefs"

local PROVIDER = "com.obsidianwidget/com.obsidianwidget.ObsidianWidgetProvider3"
...
local function refresh()
    ...
    intent:send_broadcast{
        ...
        component = "com.obsidianwidget/com.obsidianwidget.ObsidianWidgetProvider3",
    }
