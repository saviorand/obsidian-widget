...
-- literal FILENAME including the ".lua" extension -- "obsidian-panel-3.lua"
...
--     --es cmd "script:obsidian-panel-3.lua:<title>
-- <body line 1>
-- <body line 2>"
...
--   am broadcast -a ru.execbit.aiolauncher.COMMAND \
--     --es cmd 'script:obsidian-panel-3.lua:chart:{"points":[[1700000000000,3],[1700086400000,5]],"format":"x:date y:number","title":"Tasks done","show_grid":true}'
...
--   am broadcast -a ru.execbit.aiolauncher.COMMAND \
--     --es cmd 'script:obsidian-panel-3.lua:layout:{"elements":[["text","<b>Tasks</b>",{"size":20}],["new_line",2],["progress","Today",{"progress":70}],["new_line",2],["button","Open Todo",{"color":"#00aa00"}]],"actions":{"3":"@Todo.md"}}'
